...
export function VerdictStamp({
  ...
  return (
    <span
      className={`inline-flex -rotate-2 flex-col items-center rounded-[3px] border-2 outline outline-1 outline-offset-[3px] ${s.border} ${s.tint} ${pad} ${s.border.replace("border-", "outline-")}`}
    >
      <span
